...
@if(session()->has('message'))
    <div class="w-4/5 m-auto mt-10 pl-2">
        <p class="w-2/6 mb-4 text-gray-50 bg-green-500 rounded-2xl py-4 pl-4">
            {{ session()->get('message') }}
        </p>
    </div>
@endif
    ...
    <div class="sm:grid grid-cols-2 gap-20 w-4/5 mx-auto py-15 border-b border-gray-200">
        ...
        <div>
            ...
            <p class="text-xl text-gray-700 pt-8 pb-10 leading-8 font-light">
                ...
                Molestiae aliquid, non eos nihil qui ut porro eum. 
                Itaque vel sapiente ab beatae eius illum dolores in, 
                hic nulla aliquid totam. -->
                {{ $post->description }}
            </p>
